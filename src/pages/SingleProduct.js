...
const SingleProduct = () => {
  ...
  return (
    <div className="single-product home-wrapper-2">
            ...
            <div className="col-md-6">
              <div className="card p-3 rounded product-info">
                ...
                <div className="information">
                  ...
                  <p>
                    <strong className="mr-2">Collections: </strong>Android
                    Phones, Headphones, Our Store, Phones, Sale Collection,
                    Smart Phones,
                  </p>
                  <p>
      ...
      <section className="review-wrapper py-5 " id="write_review">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
